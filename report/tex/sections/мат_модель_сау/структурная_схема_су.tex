...
Полученные выражения позволяют построить структурную схему системы управления, представленную на рисунке~\ref{fig:structural_scheme}.

\begin{figure}[H]
    \centering
    \resizebox{\textwidth}{!}{
        \input{tex/graphics/figures/structural_scheme}
    }
